...
const Services = () => {
  return (
    <div id="services" className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>I build fast, secure, and mobile-friendly web applications using modern frameworks like React and Next.js.</p>
